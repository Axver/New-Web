...
<body class="index-page sidebar-collapse" onload='load()'>
      ...
      <div class="row">
        <div class="col-md-8 ml-auto mr-auto">
          <div class="brand">
            ...
            <button class='btn btn-info' onclick='redirect()'>Home</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="section section-tabs">
      ...
      <div class="section section-download" id="downloadSection">
        <div class="container">
          ...
          <div class="sharing-area text-center">
            <button onclick="test1()" id="twitter" class="btn btn-raised btn-twitter sharrre">
    ...
    <script>
      ...
      {
        alert("test");
        window.location.href="https://api.whatsapp.com/send?phone=086576199777&text=Hai Admin, saya ingin bertanya seputar produk";
      }
